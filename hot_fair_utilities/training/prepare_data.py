...
def split_training_2_validation_2_prediction(input_path, output_path):
    """Converts training 2 validation and prediction

    Currently supported for ramp, It converts training dataset provided by preprocessing script to validation datasets required by ramp and prediction datasets for assessing prediction
    """
